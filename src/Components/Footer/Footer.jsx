        ...
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-9">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
               <h1 className='text-xl text-white'> Arif Almas</h1>
                <p className='text-md text-gray-300 md:mt-8 md:mb-20 my-4'>625 E Franklin Ave, Minneapolis, <br/>  NY 35004, USA</p>
                <p className='text-md text-gray-300'>@ 2021 <a className='underline' href="https://arifalmas.netlify.app/">Arif A.</a>. All rights reserved.</p>
              </div>
              <div>
                <div>
              ...
              <div>
                  ...
                  <ul  className='flex flex-col md:gap-5 gap-2'>
                    ...
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        <span><a href="mailto:arifalmasdev@gmail.com"> <HiOutlineMail className='text-2xl' /></a></span>
                        <span><a href="mailto:arifalmasdev@gmail.com">arifalmasdev@gmail.com</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center my-6 ml-3'>
                        <span><a href="mailto:arifalmasdev@gmail.com"> <FaFacebookF className='text-2xl' /></a></span>
                        <span><a href="mailto:arifalmasdev@gmail.com"><BsInstagram className='text-2xl'/> </a></span>
                        <span><a href="mailto:arifalmasdev@gmail.com"><AiOutlineTwitter className='text-2xl'/></a></span>
                    </li>
                  </ul>
                </div>
              </div>
